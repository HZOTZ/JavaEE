...
<body>
    <ul class="mainmenu">
        <li><a href="${pageContext.request.contextPath}/servlet/borrowInfoServlet" ><b><img src="../images/bg.jpg" /></b><span>借书查询</span></a></li>
        <li><a href="/" ><b><img src="../images/bg.jpg" /></b><span>个人中心</span></a></li>
        <li><a href="/" ><b><img src="../images/bg.jpg" /></b><span>书籍查询</span></a></li>
        <li><a href="/" ><b><img src="../images/bg.jpg" /></b><span>借阅记录</span></a></li>
        <li><a href="/" ><b><img src="../images/bg.jpg" /></b><span>下载中心</span></a></li>
