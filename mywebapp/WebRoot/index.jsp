	...
	<div class="container">
		<header>
			<nav class="codrops-demos">
				<span>Welcome <strong>"Admin&Manager"</strong> to This
					Library
				</span>
			</nav>
		</header>
			...
			<div id="container_demo">
				...
				<div id="wrapper">
					<div id="login" class="animate form">
						<form
							action="${pageContext.request.contextPath}/servlet/chkLoginServlet"
					...
					<div id="register" class="animate form">
						<form action="${pageContext.request.contextPath}/servlet/registerServlet" autocomplete="on" method="post">
							<h1>Sign up</h1>
							...
							<p>
								<label for="passwordsignup_confirm" class="youpasswd"
									...
									required="required" type="password" placeholder="eg. password" onBlur="checkpwd()"/>
								<span id="hit"></span>							
							</p>
						...
						function checkpwd(){
							...
							var confpwd=document.getElementById("passwordsignup_confirm").value;
							if(pwd!=confpwd){
								document.getElementById("hit").innerHTML="<font color='red'>Two times the password is not the same</font>";
				                document.getElementById("Sign_up").disabled = true;
								
							}else{
								document.getElementById("hit").innerHTML="<font color='green'>Two times the password is the same</font>";
